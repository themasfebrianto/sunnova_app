...
mixin _$UserAchievement {
 ...
 String get id; String get userId; String get badgeId; DateTime get unlockedAt; bool get isNew;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,badgeId,unlockedAt,isNew);

@override
String toString() {
  return 'UserAchievement(id: $id, userId: $userId, badgeId: $badgeId, unlockedAt: $unlockedAt, isNew: $isNew)';
}
...
@useResult
$Res call({
 String id, String userId, String badgeId, DateTime unlockedAt, bool isNew
});
...
/// Create a copy of UserAchievement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? badgeId = null,Object? unlockedAt = null,Object? isNew = null,}) {
...
as DateTime,isNew: null == isNew ? _self.isNew : isNew // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String badgeId,  DateTime unlockedAt,  bool isNew)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserAchievement() when $default != null:
return $default(_that.id,_that.userId,_that.badgeId,_that.unlockedAt,_that.isNew);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String badgeId,  DateTime unlockedAt,  bool isNew)  $default,) {final _that = this;
switch (_that) {
case _UserAchievement():
return $default(_that.id,_that.userId,_that.badgeId,_that.unlockedAt,_that.isNew);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String badgeId,  DateTime unlockedAt,  bool isNew)?  $default,) {final _that = this;
switch (_that) {
case _UserAchievement() when $default != null:
return $default(_that.id,_that.userId,_that.badgeId,_that.unlockedAt,_that.isNew);case _:
  return null;
...
class _UserAchievement implements UserAchievement {
  const _UserAchievement({required this.id, required this.userId, required this.badgeId, required this.unlockedAt, required this.isNew});
...
/// Create a copy of UserAchievement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? badgeId = null,Object? unlockedAt = null,Object? isNew = null,}) {
